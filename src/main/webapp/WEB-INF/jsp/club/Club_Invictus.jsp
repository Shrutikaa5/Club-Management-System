                ...
                <ul class="navbar-nav ml-auto px-lg-4">
                    ...
                    <li class="nav-item px-3">
                        <form action="Profile" method="post">
                            ...
                            <button type="submit" value="${UserName}" ></button>
                                    ...
                                    <body>
                                        <div class="container">
                                            ...
                                            <div class="info-contain">
                                                <h3>Information</h3>
                                                <div class="box">
                                                    TEAM INVICTUS is a official robotics club of MITAOE. 
                                                    <p>The primary aim of robotics club is to provide an opportunity to benchmark skills, 
                                                        to create a robotic engineer on campus and support them for training, providing resources available from concept to execution. </p>
                                                    Objectives is to train students to participate in various robotic competitions at National and international levels.               
                                                </div>
