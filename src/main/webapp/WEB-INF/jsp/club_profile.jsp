            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto px-lg-4">
                    <!--                    <li class="nav-item px-3">
                                            <form action="wlcmclub" method="post">
                                                <input type="hidden" value="${cname}" name="cname">
                                                <input type="hidden" value="${eemail}" name="cemail"> comment 
                                                <input type="hidden" value="${cpass}" name="cpassword">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <p class="mb-0"><strong class="pr-1">Name of Club: ${cname}</strong></p>
                                <p class="mb-0"><strong class="pr-1">Domain of Club:  ${domain}</strong></p>                                                                
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body pt-0">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th width="30%">Other Information:  </th>
                                        <td width="2%">:</td>
                                        <td>${other}</td>
                                    </tr>
                                    <tr>
